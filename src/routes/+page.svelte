<script lang="ts">
    ...
    const cardIcons = [
        { icon: '<i class="ph ph-broadcast"></i>', label: 'Broadcast' },
        { icon: '<i class="ph ph-bank"></i>', label: 'Bank' },
        { icon: '<i class="ph ph-beach-ball"></i>', label: 'Bail' },
        { icon: '<i class="ph ph-book-open-text"></i>', label: 'Open Text' },
        { icon: '<i class="ph ph-calendar-plus"></i>', label: 'Calender Plus' },
        { icon: '<i class="ph ph-car"></i>', label: 'Car Drive' },
    ];
...
>
    <!-- heading  -->
    <div
        class="text-lg font-medium flex items-center min-h-20 flex justify-between"
    >
        <div>Sitemap</div>
    ...
    >
                                            ...
                                            >
                                                <svg
                                                    ...
                                                    ><path
                                                        ...
                                                        fill="black"
                                                    /><path
                                                        d="M1820.4 549.8H2053.6L1568.1 1053.2C1392.3 1235.5 1107.3 1235.5 931.9 1053.2L446.3 549.8H679.5L1048.2 932.2C1159.7 1047.5 1340 1047.5 1451.2 932.2L1820.4 549.8ZM676.6 1950.2H443.3L931.9 1443.4C1107.71261.1 1392.7 1261.1 1568.5 1443.4L2057.1 1950.2H1823.8L1452 1564.4C1340.5 1449.1 1160.2 1449.1 1049 1564.4L676.6 1950.2Z"
                                                        fill="white"
                                                    /></svg
                                                >
                                                <span
                                    ...
                                    <tr>
                                        ...
                                        >
                                            ...
                                            >
                                                ...
                                                >
                                                    <path
                                                        d="M244.6 0.5H245C379.9 0.5 489.3 109.9 489.3 244.8V258.4C489.3 393.3 379.9 502.7 245 502.7H244.6C109.7 502.7 0.299988 393.3 0.299988 258.4V244.8C0.299988 109.9 109.7 0.5 244.6 0.5Z"
                                                        fill="#232323"
                                                    />
                                                    <path
                                                        d="M349.3 189.5C348.5 190.4 347.5 191.1 346.4 191.5C345.3 192 344.1 192.2 342.9 192.2H116.4C108.4 192.2 104.3 182.2 109.9 176.2L147.1 136.7C147.9 135.8 148.9 135.1 150.1 134.6C151.2 134.1 152.4 133.9 153.6 133.9H381C389.1 133.9 393.1 144 387.4 150L349.3 189.5ZM349.3 366.1C347.6 367.8 345.3 368.8 342.9 368.8H116.4C108.4 368.8 104.3 359 109.9 353.2L147.1 314.6C147.9 313.7 149 313 150.1 312.6C151.2 312.1 152.4 311.9 153.6 311.9H381C389.1 311.9 393.1 321.8 387.4 327.6L349.3 366.1ZM349.3 225.6C347.6 223.9 345.3 222.9 342.9 222.9H116.4C108.4 222.9 104.3 232.7 109.9 238.5L147.1 277.1C147.9 278 149 278.7 150.1 279.1C151.2 279.6 152.4 279.8 153.6 279.8H381C389.1 279.8 393.1 269.9 387.4 264.1L349.3 225.6Z"
                                                        fill="url(#paint0_linear_93_221)"
                                                    />
                                                    <defs>
                                                        <linearGradient
                                                            id="paint0_linear_93_221"
                                                            x1="124.604"
                                                            y1="371.732"
                                                            x2="372.039"
                                                            y2="130.833"
        ...
        <div
            class=" {isExpand
                ? ' gap-6 grid grid-cols-[repeat(auto-fit,minmax(600px,1fr))]'
                : ' gap-6 grid grid-cols-[repeat(auto-fit,minmax(300px,1fr))]'}"
        >
            {#each cardsData as card}
                <div
                    class="border border-neutral-300 w-full rounded-lg bg-white flex flex-col"
                >
                    <div
                    ...
                    <div class="h-auto p-6 text-neutral-500">
                        <div
                            class="grid grid-cols-[repeat(auto-fit,minmax(100px,1fr))] gap-3"
                        >
                            {#each cardIcons as icon}
                                <div
                                    class="border border-gray-300 rounded-lg shadow-sm hover:shadow-lg cursor-pointer flex items-center justify-center flex-col pt-4 pb-4 transition-all delay-75"
                                >
                                    <div
                                        class="text-4xl font-normal text-gray-900 mb-1"
                                    >
                                        {@html icon.icon}
                                    </div>
                                    <div class="text-sm">
