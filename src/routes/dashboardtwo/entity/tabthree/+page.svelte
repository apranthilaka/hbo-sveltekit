<script>
    // Tab 2 specific logic here
</script>

<div
    class="responsive-wrapper w-full max-w-full md:max-w-3xl lg:max-w-4xl xl:max-w-6xl gap-6 flex flex-col mb-6 pt-6 overflow-y-auto [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden"
>
    <!-- Table Section -->
    <div class="w-full">
        <!-- Card -->
                    ...
                    >
                        ...
                        <div class="px-6 py-4 border-b border-gray-200">
                            ...
                            <p class="text-sm text-gray-600">
                                ...
                                $1.09 Trillion, a <span class="text-green-500"
                                    >0.5%</span
